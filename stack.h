...
/*  
	...
	as a linked list. Elements, specifically characters for the Balanced Brackets project, can be 
	pushed onto and popped from the stack. Memory relating to instances of this implementation of 
	the stack are allocated to the heap with the stack_init() function, and must be freed with 
	the stack_dealloc() function.
*/
